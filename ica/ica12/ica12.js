...
while (balls.length < 25) {
    const size = random(10,20); // determining hypothetical smallest and largest ball we could have
    const ball = new Ball(
        random(0 + size, width - size), // random postion
        random(0 + size, height - size), // random postion
